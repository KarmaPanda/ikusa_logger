...
copy update.ps1 dist\ikusa-logger\update.ps1 /Y
copy check-update.bat dist\ikusa-logger\check-update.bat /Y
copy check-update.ps1 dist\ikusa-logger\check-update.ps1 /Y
